...
proc p_elaboration {} {
  ...
  set_interface_property m_cmd associatedReset if_resestn
  ...
  set_interface_property m_sdo associatedReset if_resestn
  ...
  set_interface_property m_sdi associatedReset if_resestn
  ...
  set_interface_property m_sync associatedReset if_resestn
  ...
  set_interface_property s0_cmd associatedReset if_resestn
  ...
  set_interface_property s0_sdo associatedReset if_resestn
  ...
  set_interface_property s0_sdi associatedReset if_resestn
  ...
  add_interface_port s0_sync s0_sync_data tdata output 8

  set_interface_property s0_sync associatedClock if_clk
  set_interface_property s0_sync associatedReset if_resestn
  ...
  set_interface_property s1_cmd associatedReset if_resestn
  ...
  set_interface_property s1_sdo associatedReset if_resestn
  ...
  set_interface_property s1_sdi associatedReset if_resestn
  ...
  set_interface_property s1_sync associatedReset if_resestn
