...
module system_top (
  ...
  assign spi_csn_adrv9009_c = spi_3_to_8_csn[4];
  assign spi_csn_adrv9009_d = spi_3_to_8_csn[5];
  assign spi_csn_fmc_hmc7044 = spi_3_to_8_csn[6];

  assign spi_fmc_clk = spi_fmc_clk;
  assign spi_miso_s = (spi_3_to_8_csn[4] & spi_3_to_8_csn[5]) == 0 ? spi_fmc_miso : spi_miso;
